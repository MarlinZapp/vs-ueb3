...
public class Simulation {
    ...
    public static int SIMULATION_TIME_MILLIS = 3000;
    ...
    // each fish wants a new decision after this a random amount of milliseconds between 0 and this
    public static int NEW_DECISION_TIMER_MILLIS_MAX = 100;
